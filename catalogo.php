            					...
            					<div class="col-md-9 col-sm-8 col-xs-12 main-content">
            						...
            						<div class="category-toolbar clearfix">
    									<div class="toolbox-filter clearfix">
    										...
    										<div class="view-box">
                                                <a href="catalogo.php?cod_principal=<?php echo $xCodPrix; ?>" class="active icon-button icon-grid"><i class="fa fa-th-large"></i></a>
                                                <a href="catalogo-list.php?cod_principal=<?php echo $xCodPrix; ?>" class="icon-button icon-list"><i class="fa fa-th-list"></i></a>
                                            </div><!-- End .view-box -->
