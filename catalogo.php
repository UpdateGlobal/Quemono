                                        ...
                                        <div class="row">
                    						...
                    						<div class="category-toolbar clearfix">
            									<div class="toolbox-filter clearfix">
            										...
            										<div class="view-box">
                                                        <a href="/catalogos/<?php echo $slug; ?>" class="active icon-button icon-grid"><i class="fa fa-th-large"></i></a>
                                                        <a href="/catalogo/<?php echo $slug; ?>" class="icon-button icon-list"><i class="fa fa-th-list"></i></a>
                                                    </div><!-- End .view-box -->
            										...
            										<?php
                                                        ...
                                                        if ($total_paginas>1){
                                                            echo "
                                                                <ul class='pagination'>";
                                                            if($pagina>1){
                                                                echo "<li><a href='/catalogos/".$slug."&p=".($pagina-1)."'><i class='fa fa-angle-left'></i></a></li>";
                                                            }
                                                            for($i=$pagina; $i<=$total_paginas && $i<=($pagina+$paginas_mostrar); $i++){
                                                                if($i==$pagina){
                                                                    echo "<li class='active'><a>$i</a></li>";
                                                                }else{
                                                                    echo "<li><a href='/catalogos/".$slug."&p=$i'>$i</a></li>";
                                                                }
                                                            }
                                                            ...
                                                            if($pagina<$total_paginas){
                                                                echo "  <li><a href='/catalogos/".$slug."&p=".($pagina+1)."'><i class='fa fa-angle-right'></i></a></li>";
                                                            }
                                                            echo "</ul>";
                                                        }
                                                    ?>
