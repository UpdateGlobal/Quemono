...
$mensaje = '
	<table width="100%" border=1 cellpadding=0 cellspacing=0 align=center>
		<tr>
			...
			<th width="20%" scope=col>CODIGO</th>
...
$mensaje.= '
		<tr>
			<td>'.$num.'</td>
       		...
       		<td>'.$xCodigo.'</td>
       		<td>'.$xCantidad.'</td>
       		<td>S/.'.number_format($pmostrar,2).'</td>
...
$mensaje.= '
	...
	<table width="100%" border=0 align=center cellpadding=0 cellspacing=0>
   		<tr>
   		    ...
   		    <td width="80%">'.utf8_decode($filaCli['nombres']).'</td>
	    </tr>
   		<tr>
   		    <td width="20%"><strong>Direcci&oacute;n :</strong></td>
   		    <td width="80%">'.utf8_decode($filaCli['direccion']).'</td>
	    </tr>
   		<tr>
