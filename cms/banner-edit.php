...
if($proceso == ""){
  ...
  $precio = htmlspecialchars($filaBan['precio']);
  $oferta = htmlspecialchars($filaBan['oferta']);
  $orden  = $filaBan['orden'];
...
if($proceso=="Actualizar"){ 
  ...
  $precio       = mysqli_real_escape_string($enlaces, $_POST['precio']);
  $oferta       = mysqli_real_escape_string($enlaces, $_POST['oferta']);
  if(isset($_POST['orden'])){$orden = $_POST['orden'];}else{$orden = 0;}
  if(isset($_POST['estado'])){$estado = $_POST['estado'];}else{$estado = 0;}
  $actualizarBanner = "UPDATE banners SET cod_banner='$cod_banner', imagen='$imagen', titulo='$titulo', texto='$texto', precio='$precio', oferta='$oferta', orden='$orden', estado='$estado' WHERE cod_banner='$cod_banner'";
        ...
        <div class="card">
          ...
          <form class="fcms" name="fcms" method="post" action="" data-provide="validation" data-disable="false">
            <div class="card-body">
              ...
              <div class="form-group row">
                <div class="col-4 col-lg-2">
                  <label class="col-form-label" for="oferta">Oferta:</label>
                </div>
                <div class="col-8 col-lg-10">
                  <input class="form-control" name="oferta" type="text" id="oferta" value="<?php echo $oferta; ?>" />
                </div>
              </div>
