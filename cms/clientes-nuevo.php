...
if($proceso == "Registrar"){
  ...
  if($numreg==0){
    $insertarClientes = "INSERT INTO clientes(nombres, email, clave, direccion, telefono, estado)VALUE('$nombres', '$email', '$clave', '$direccion', '$telefono', '$estado')";
        ...
        <div class="card">
          ...
          <form class="fcms" name="fcms" method="post" action="" data-provide="validation" data-disable="false">
            <div class="card-body">
              ...
              <div class="form-group row">
                <div class="col-4 col-lg-2">
                  <label class="col-form-label" for="telefono">Tel&eacute;fono:</label>
                </div>
                <div class="col-8 col-lg-10">
