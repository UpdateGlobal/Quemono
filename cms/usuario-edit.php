...
if($proceso == "Actualizar"){
  ...
  if($_POST['clave']==""){
    $actualizarUsuarios = "UPDATE usuarios SET cod_usuario='$cod_usuario', nombres='$nombres', email='$email', imagen='$imagen', usuario='$usuario', visitante='$visitante', estado='$estado' WHERE cod_usuario='$cod_usuario'";
  }else{
          ...
          <form class="fcms" name="fcms" method="post" action="" data-provide="validation" data-disable="false">
            <div class="card-body">
              ...
              <div class="form-group row">
                ...
                <div class="col-4 col-lg-8">
                  <img class="d-block b-1 border-light hover-shadow-2 p-1 img-admin" src="assets/img/avatar/<?php echo $imagen; ?>" />
                </div>
