...
if($proceso == "Actualizar"){
  ...
  $ActualizarCon = "UPDATE ofertas SET cod_ofertas='$cod_ofertas', imagen='$imagen', link='$link', estado='$estado' WHERE cod_ofertas='$cod_ofertas'";
  ...
  <head>
    ...
    <script>
      function Validar(){
        ...
        document.fcms.action = "ofertas-edit.php";
  ...
  <body>
    ...
    <main>
      ...
      <div class="main-content">
        <div class="card">
          <h4 class="card-title"><strong>Editar Oferta/Banner</strong></h4>
