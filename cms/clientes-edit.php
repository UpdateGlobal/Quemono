...
if($proceso=="Actualizar"){ 
  ...
  $estado       = $_POST['estado'];
  if($_POST['clave']==""){
    $actualizarClientes = "UPDATE clientes SET cod_cliente='$cod_cliente', nombres='$nombres', email='$email', direccion='$direccion', telefono='$telefono',  estado='$estado' WHERE cod_cliente='$cod_cliente'";
  }else{
    $actualizarClientes = "UPDATE clientes SET cod_cliente='$cod_cliente', nombres='$nombres', email='$email', clave='$clave', direccion='$direccion', telefono='$telefono', estado='$estado' WHERE cod_cliente='$cod_cliente'";
  }
        ...
        <div class="card">
          ...
          <form class="fcms" name="fcms" method="post" action="" data-provide="validation" data-disable="false">
            <div class="card-body">
              ...
              <div class="form-group row">
                <div class="col-4 col-lg-2">
                  <label class="col-form-label required" for="clave">Clave:</label><br>
                  <small>Dejar en blanco si no va a modificar</small>
                </div>
                <div class="col-8 col-lg-10">
                  <input class="form-control" name="clave" type="text" id="clave" value="" required />
                </div>
              </div>
