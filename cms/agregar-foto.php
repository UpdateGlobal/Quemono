...
<script>
	function Validar() {
		...
		if (document.imagenes.imagen.value=="") {
			...
			if ((tipo !="jpg") && (tipo !="JPG") && (tipo !="pdf") && (tipo !="PDF") && (tipo !="ico") && (tipo !="ICO") && (tipo !="png") && (tipo !="PNG") && (tipo !="svg") && (tipo !="SVG")) {
			alert("Debe de seleccionar Archivo de tipo JPG, PDF, PNG, SVG o ICO")
			return
		}
