...
if($proceso == "Registrar"){
  ...
  $insertarBanner = "INSERT INTO banners(imagen, titulo, texto, precio, oferta, orden, estado)VALUE('$imagen', '$titulo', '$texto', '$precio', '$oferta', '$orden', '$estado')";
          ...
          <form class="fcms" name="fcms" method="post" action="" data-provide="validation" data-disable="false">
            <div class="card-body">
              ...
              <div class="form-group row">
                ...
                <div class="col-8 col-lg-10">
                  <input class="form-control" name="oferta" type="text" id="oferta" />
                </div>
              </div>
