                                        ...
                                        <div class="row">
                                            ...
                                            <div class="category-toolbar clearfix">
                                                <div class="toolbox-filter clearfix">
                                                    ...
                                                    <div class="view-box">
                                                        <a href="/categorias/<?php echo $slug; ?>" class="active icon-button icon-grid"><i class="fa fa-th-large"></i></a>
                                                        <a href="/categoria/<?php echo $slug; ?>" class="icon-button icon-list"><i class="fa fa-th-list"></i></a>
                                                    </div><!-- End .view-box -->
